...
# 3. Edit src/llmConfig.js and change:
...
# 3. Start Ollama:
ollama serve
# 4. Edit src/llmConfig.js and change:
...
- **`src/llmConfig.js`** - Main configuration (API endpoint, model, parameters)
...
→ Verify your API endpoint in `src/llmConfig.js`  
...
- Customize the system prompt in `src/llmConfig.js`
